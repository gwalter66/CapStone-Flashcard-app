...
### Home Page:
![home screen](<readme-screenshots/Screenshot (54).png>)
...
![delete deck warning](<readme-screenshots/Screenshot (55).png>)

### Study Screen:
![study deck screen](<readme-screenshots/Screenshot (56).png>)
...
![next button](<readme-screenshots/Screenshot (57).png>)
...
![restart prompt](<readme-screenshots/Screenshot (58).png>)
...
![not enough cards promt](<readme-screenshots/Screenshot (59).png>)

### Create Deck:
![create deck screen](<readme-screenshots/Screenshot (60).png>)
...
### Deck Screen:
![deck screen](<readme-screenshots/Screenshot (61).png>)
...
![delete card promp](<readme-screenshots/Screenshot (62).png>)

### Edit Deck:
![edit deck screen](<readme-screenshots/Screenshot (63).png>)
...
### Add Card:
![add card screen](<readme-screenshots/Screenshot (64).png>)
...
### Edit Card:
![edit card screen](<readme-screenshots/Screenshot (65).png>)
...
- If the user clicks on either the `Cancel` or `Submit` button, the user is taken back to the D